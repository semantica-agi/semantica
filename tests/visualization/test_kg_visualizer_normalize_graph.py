...
class TestFormalKnowledgeGraphType(unittest.TestCase):
    ...
    # ------------------------------------------------------------------
    # _convert_knowledge_graph produces correct dict shape
    # ------------------------------------------------------------------
    ...
    def test_convert_knowledge_graph_does_not_mutate(self):
        """Original KnowledgeGraph must not be mutated during conversion."""
        kg = self._make_kg()
    ...
    def test_convert_knowledge_graph_is_deterministic(self):
        ...
        kg = self._make_kg()
        viz = _make_viz()
        result1 = viz._convert_knowledge_graph(kg)
        result2 = viz._convert_knowledge_graph(kg)
        self.assertEqual(result1, result2)

    # ------------------------------------------------------------------
    # _normalize_graph routes KnowledgeGraph through _convert_knowledge_graph
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # All five visualize_* entry points accept KnowledgeGraph
    # ------------------------------------------------------------------
